...
const AppointmentSection = ({ title }: AppoitnmentSectionProps) => {
  return (
    <section className="flex flex-col gap-2 bg-white rounded-xl shadow-sm w-full">
      ...
      <Link href="/chat" passHref>
        <a className="bg-gray-700 text-white flex px-6 py-6 rounded-b-xl items-center justify-center">
          <div className="flex items-center gap-2">
